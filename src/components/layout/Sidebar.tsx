        ...
        <div className="p-6 border-b border-sidebar-border flex items-center justify-between">
          {!collapsed && (
            <div className="flex items-center gap-2">
              ...
              <span className="font-orbitron text-xl font-bold text-primary">BlackBox AI</span>
            </div>
          )}
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive && "bg-sidebar-accent border border-primary/30 text-primary cyber-glow",
