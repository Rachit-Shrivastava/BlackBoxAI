    ...
    extend: {
      colors: {
        ...
        secondary: {
          ...
          from: "hsl(var(--secondary-from))",
          to: "hsl(var(--secondary-to))",
        },
        destructive: {
        ...
        success: {
          ...
          from: "hsl(var(--success-from))",
          to: "hsl(var(--success-to))",
        },
        warning: {
      ...
      backgroundImage: {
        'gradient-primary': 'var(--gradient-blue-cyan)',
        'gradient-secondary': 'var(--gradient-purple-indigo)',
        'gradient-success': 'var(--gradient-emerald-teal)',
        'gradient-ocean': 'var(--gradient-ocean-deep)',
